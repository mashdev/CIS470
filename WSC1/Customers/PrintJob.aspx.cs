    ...
    public partial class PrintJob : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack)
            {
                ...
                int ddlPid = Convert.ToInt32(ddlPrintType.SelectedValue);
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("PrintConfirmation.aspx?printType=" + ddlPrintType.SelectedValue + "&qty=" + txtQuantity.Text + "&desc=" + TextBox1.Text);
